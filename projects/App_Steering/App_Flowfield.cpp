...
void App_Flowfield::RemoveAgent(UINT index)
{
...
App_Flowfield::ImGui_Agent App_Flowfield::AddAgent(BehaviorTypes behaviorType, int targetId, bool autoOrient, float mass, float maxSpd)
{
	ImGui_Agent agent = {};
...
void App_Flowfield::SetAgentBehavior(ImGui_Agent& a)
{
	SAFE_DELETE(a.pBehavior);
...
void App_Flowfield::UpdateTarget(ImGui_Agent& a)
{
...
void App_Flowfield::UpdateTargetLabel()
{
	m_TargetLabelsVec.clear();
...
void App_Flowfield::AddObstacle()
{
...
Elite::Vector2 App_Flowfield::GetRandomObstaclePosition(float newRadius, bool& positionFound)
{
	positionFound = false;
	Elite::Vector2 pos;
	int tries = 0;
